defmodule Html do
  # Ensure that our Html module is recompiled by mix any time the tags.txt file changes
  ...
  defmacro markup(do: block) do
    quote do
      ...
      # Overriding hygiene here lets us implicitly store state behind the scenes from the caller and avoid
      # clashes by generating the buffer in our Html context
